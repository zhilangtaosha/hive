#!/bin/bash
#***********************************************************************************
# **  文件名称: dws_wdtb_trmnl_regst_user_info_msk_m.sh
# **  创建日期: 2017年9月29日
# **  编写人员: lgc
# **  输入信息: 
# **  输出信息: 
...
###############配置区############################################################################
#脚本名称
LOGNAME="dws_wdtb_trmnl_regst_user_info_msk_m"
...
#正常执行hql
SQL="
insert overwrite table dws_m.dws_wdtb_trmnl_regst_user_info_msk_m partition (prov_id, month_id)
 select MD5Encode(mdn),
        prov_name,
        city_id,
        change_cnt,
        change_dur,
