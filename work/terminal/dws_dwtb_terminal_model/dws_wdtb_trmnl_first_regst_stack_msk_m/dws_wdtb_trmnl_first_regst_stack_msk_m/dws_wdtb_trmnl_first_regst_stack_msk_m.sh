#!/bin/bash
#***********************************************************************************
# **  文件名称: dws_wdtb_trmnl_first_regst_stack_msk_m.sh
# **  创建日期: 2017年9月29日
# **  编写人员: lgc
# **  输入信息: 
# **  输出信息: 
...
###############配置区############################################################################
#脚本名称
LOGNAME="dws_wdtb_trmnl_first_regst_stack_msk_m"
...
#输出lzo文件参数：set mapred.output.compression.codec=com.hadoop.compression.lzo.LzopCodec; 
#常规参数
...
set mapred.min.split.size.per.rack=256000000; set hive.hadoop.supports.splittable.combineinputformat=true;
set hive.merge.mapfiles = true;
set hive.merge.mapredfiles= true;
set hive.merge.size.per.task=134217728;
set hive.merge.smallfiles.avgsize=150000000;
set hive.hadoop.supports.splittable.combineinputformat=true;
add jar ${baseDirForScriptSelf}/BoncHiveUDF.jar;
CREATE TEMPORARY FUNCTION MD5Encode AS 'com.bonc.hive.MyMD5';"
#合并小文件参数
...
#正常执行hql
SQL="
insert overwrite table dws_m.dws_wdtb_trmnl_first_regst_stack_msk_m partition (prov_id,month_id)
select 
md5encode(meid) as meid,
md5encode(mdn) as accs_nbr,
...
prov_id,
month_id
from dws_integ.dws_wdtb_trmnl_first_regst_m
