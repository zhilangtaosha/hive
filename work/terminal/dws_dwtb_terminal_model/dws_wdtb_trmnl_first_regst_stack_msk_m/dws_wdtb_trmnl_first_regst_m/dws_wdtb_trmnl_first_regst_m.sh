#!/bin/bash
#***********************************************************************************
# **  文件名称: dws_wdtb_trmnl_first_regst_m.sh
# **  创建日期: 2017年08月24日
# **  编写人员: qiaoyin
# **  输入信息: 
...
###############配置区############################################################################
#脚本名称
LOGNAME="dws_wdtb_trmnl_first_regst_m.sh"
...
#
SQL="insert overwrite table dws_integ.dws_wdtb_trmnl_first_regst_m partition (prov_id,month_id)
select 
meid as meid,
mdn as accs_nbr,
imsi as imsi,
...
prov_id,
month_id
from dwi_integ.dwi_res_serv_trmnl_first_regst_m
