#!/bin/bash
#***********************************************************************************
# **  文件名称: dwi_res_netk_bsa_4g_list_info_msk_m.sh
# **  创建日期: 2018年6月14日
# **  编写人员: hgd
# **  输入信息: 
# **  输出信息: 
...
###############配置区############################################################################
#脚本名称
LOGNAME="dwi_res_netk_bsa_4g_list_info_msk_m"
...
insert overwrite table dwi_m.dwi_res_netk_bsa_4g_list_info_msk_m partition(month_id )
select t.int_id,
       t.cel_code,
       t.related_enb_int_id,
	   t.related_enb_id,
       t.related_enb_name,
       t.prov_id,
       t.prov_name,
       ...
       t.lati,
       t.month_id
from dwi_integ.dwi_res_netk_bsa_4g_list_info_m t
where month_id='${MONTH_ID}';"
RunScript "${SQL}"

#合并小文件方法
Mergefile "${USERNAME}" "dwi_res_netk_bsa_4g_list_info_msk_m" "where month_id = '${MONTH_ID}'"
